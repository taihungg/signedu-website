  ...
  return (
    <footer className="bg-white pt-16 md:pt-10 pb-8 mt-auto border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-center justify-between gap-12 mb-8">

          {/* Brand Block */}
          <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-sm">
            <Link href="/" className="inline-block transition-transform hover:scale-105 duration-300">
              <img src="/images/logo.png" alt="SignEdu Logo" className="h-24 w-auto object-contain -ml-2" />
            </Link>
            <p className="text-[#00105b]/80 font-medium text-lg italic pr-4 -mt-2">
          ...
          <div className="flex flex-col sm:flex-row items-center md:items-start gap-10 sm:gap-16">
            ...
            <div className="flex flex-col items-center sm:items-start gap-5 text-[#00105b]/85 font-medium">
              <span className="opacity-50 text-xs uppercase tracking-widest font-extrabold mt-1">Liên hệ</span>
            ...
            {/* Social Block */}
            <div className="flex flex-col items-center sm:items-start gap-5 text-[#00105b]/85 font-medium">
              <span className="opacity-50 text-xs uppercase tracking-widest font-extrabold mt-1">Theo dõi</span>
              <div className="flex flex-col gap-3">
                ...
                <a href="https://zalo.me/0348325101" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-[#0068FF] transition-colors group">
                  <div className="text-[#3D4DA3] bg-[#f4f2ff] p-2.5 rounded-2xl group-hover:bg-[#0068FF] transition-all duration-300 shadow-sm group-hover:shadow-md group-hover:-translate-y-[2px] flex items-center justify-center">
