      ...
      <div className="space-y-8 font-body text-base md:text-lg">
        <div>
          ...
          <ul className="space-y-5">
            <li className="flex gap-4 items-start">
              <span className="material-symbols-outlined text-[#83daf2] shrink-0 mt-1">check_circle</span>
              <p className="text-slate-700 leading-relaxed"><strong className="text-[#3D4DA3] font-bold">Workshop trải nghiệm Ngôn ngữ ký hiệu và giao tiếp hòa nhập:</strong> Giúp người tham gia làm quen với Ngôn ngữ ký hiệu, hiểu hơn về người Điếc và văn hóa Điếc thông qua hoạt động tương tác, thực hành, giao lưu và chia sẻ thực tế.</p>
            </li>
            <li className="flex gap-4 items-start">
              <span className="material-symbols-outlined text-[#83daf2] shrink-0 mt-1">check_circle</span>
              <p className="text-slate-700 leading-relaxed"><strong className="text-[#3D4DA3] font-bold">Chương trình giáo dục nhận thức về người Điếc và văn hóa Điếc:</strong> Cung cấp kiến thức nền tảng, góp phần thay đổi góc nhìn và xây dựng thái độ tôn trọng khác biệt trong học tập, công việc và đời sống.</p>
            </li>
          </ul>
        </div>
        <div className="bg-[#f4f2ff] p-6 md:p-8 rounded-2xl border-l-4 border-[#3D4DA3] shadow-inner">
          <h4 className="font-bold text-[#3D4DA3] flex items-center gap-2 mb-3 text-lg"><span className="material-symbols-outlined">stars</span> Cam kết của SignEdu</h4>
        ...
        <div className="pt-4 flex justify-center md:justify-start">
          <Link href="/contacts" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-[#f1d577] text-[#3D4DA3] rounded-full font-bold text-base tracking-wide hover:bg-[#e7c760] transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-1 transform active:scale-95">
            Liên hệ hợp tác <span className="material-symbols-outlined text-[18px]">handshake</span>
          </Link>
        </div>
      </div>
    )
  },
  {
    ...
    detailedContent: (
      <div className="space-y-8 font-body text-base md:text-lg">
        ...
        <div>
          <h4 className="font-bold text-[#3D4DA3] text-xl mb-4 border-b border-slate-100 pb-2">1. Thiết kế chương trình CSR và USR phù hợp</h4>
          ...
          <ul className="space-y-4">
            <li className="flex gap-4 items-start">
              <span className="material-symbols-outlined text-[#83daf2] shrink-0 mt-1">corporate_fare</span>
              <p className="text-slate-700 leading-relaxed"><strong className="text-[#00105b] font-bold">Trách nhiệm xã hội của Doanh nghiệp (CSR/DEI):</strong> Xây dựng chiến dịch hòa nhập gắn liền với giá trị thương hiệu. Tập trung vào dự án sinh kế và tạo cơ hội thực chất cho người Điếc.</p>
            </li>
            <li className="flex gap-4 items-start">
              <span className="material-symbols-outlined text-[#83daf2] shrink-0 mt-1">school</span>
              <p className="text-slate-700 leading-relaxed"><strong className="text-[#00105b] font-bold">Trách nhiệm xã hội của Trường học (USR):</strong> Lồng ghép trách nhiệm xã hội vào văn hóa học đường, tạo tiền đề định hướng nghề nghiệp hòa nhập cho học sinh, sinh viên.</p>
            </li>
          </ul>
        </div>

        <div>
          <h4 className="font-bold text-[#3D4DA3] text-xl mb-4 border-b border-slate-100 pb-2">2. Tư vấn xây dựng môi trường hòa nhập</h4>
          ...
          <ul className="space-y-4">
            <li className="flex gap-4 items-start">
              ...
              <p className="text-slate-700 leading-relaxed"><strong className="text-[#00105b] font-bold">Môi trường làm việc:</strong> Tư vấn điều chỉnh quy trình tuyển dụng; đào tạo ngôn ngữ ký hiệu và văn hóa giao tiếp cho nhân sự nòng cốt; thiết lập công cụ hỗ trợ trực quan để tối ưu năng suất.</p>
            </li>
            <li className="flex gap-4 items-start">
              <span className="material-symbols-outlined text-[#f1d577] shrink-0 mt-1">co_present</span>
              <p className="text-slate-700 leading-relaxed"><strong className="text-[#00105b] font-bold">Môi trường giáo dục:</strong> Thiết kế không gian tương tác mở, giúp học sinh nghe và học sinh Điếc kết nối bình đẳng, xóa bỏ sự cô lập.</p>
            </li>
          </ul>
        </div>

        <div>
          <h4 className="font-bold text-[#3D4DA3] text-xl mb-4 border-b border-slate-100 pb-2">3. Đo lường và Báo cáo tác động</h4>
          ...
          <div className="grid md:grid-cols-2 gap-4">
             <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                <span className="material-symbols-outlined text-[#83daf2] mb-2 text-3xl">bar_chart</span>
                <p className="text-slate-700 leading-relaxed"><strong className="text-[#00105b] block mb-1">Định lượng:</strong> Thống kê số người tiếp cận, tỷ lệ thay đổi nhận thức và số lượng nhân sự được chuẩn hóa kỹ năng.</p>
             </div>
             <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                <span className="material-symbols-outlined text-[#83daf2] mb-2 text-3xl">groups_3</span>
                <p className="text-slate-700 leading-relaxed"><strong className="text-[#00105b] block mb-1">Định tính:</strong> Đánh giá sự thay đổi văn hóa tổ chức và mức độ hài lòng của cộng đồng người Điếc.</p>
             </div>
          </div>
          <p className="text-slate-700 leading-relaxed mt-4 bg-white p-4 rounded-xl border border-dashed border-[#83daf2]"><strong className="text-[#3D4DA3]">Đầu ra:</strong> Cung cấp báo cáo tác động chuyên nghiệp, báo cáo phát triển bền vững hàng năm của đối tác.</p>
        </div>
    ...
    detailedContent: (
      <div className="space-y-6 font-body text-base md:text-lg">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-slate-50 p-6 md:p-8 rounded-2xl border border-slate-100 flex flex-col items-center text-center group hover:border-[#83daf2] hover:shadow-lg transition-all duration-300">
            <div className="w-16 h-16 bg-[#e8f6ed] text-[#1e6938] rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined text-3xl">smart_display</span>
            </div>
            <strong className="text-[#3D4DA3] font-bold mb-3 block">Học từ vựng qua video ngắn và câu chuyện thực tế</strong>
          ...
          <div className="bg-slate-50 p-6 md:p-8 rounded-2xl border border-slate-100 flex flex-col items-center text-center group hover:border-[#f1d577] hover:shadow-lg transition-all duration-300">
             <div className="w-16 h-16 bg-[#fdf8e6] text-[#b3952f] rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined text-3xl">public</span>
            </div>
            <strong className="text-[#3D4DA3] font-bold mb-3 block">Tiếp cận kiến thức về người Điếc và văn hóa Điếc</strong>
          ...
          <div className="bg-slate-50 p-6 md:p-8 rounded-2xl border border-slate-100 flex flex-col items-center text-center group hover:border-[#3D4DA3] hover:shadow-lg transition-all duration-300">
             <div className="w-16 h-16 bg-[#f4f2ff] text-[#3D4DA3] rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              <span className="material-symbols-outlined text-3xl">support_agent</span>
            </div>
            <strong className="text-[#3D4DA3] font-bold mb-3 block">Liên hệ và đăng ký dịch vụ với SignEdu</strong>
    ...
    <>
      <section className="py-24 md:py-32 w-full max-w-7xl mx-auto px-6 md:px-8">
        <div className="text-center space-y-6 mb-20 max-w-3xl mx-auto">
          <span className="inline-block px-4 py-2 bg-[#f4f2ff] text-[#3D4DA3] rounded-full text-sm font-bold tracking-widest uppercase mb-2 border border-[#3D4DA3]/10">Dịch vụ cốt lõi</span>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="p-8 md:p-10 flex flex-col flex-grow">
                <h3 className="text-2xl font-bold font-headline text-[#00105b] mb-4 group-hover:text-[#3D4DA3] transition-colors">{service.title}</h3>
                ...
                {/* CTA Button */}
                <button className="mt-auto w-full py-4 rounded-full bg-[#f4f2ff] text-[#3D4DA3] font-bold text-sm tracking-widest uppercase hover:bg-[#3D4DA3] hover:text-white transition-colors duration-300 flex items-center justify-center gap-2 group-hover:shadow-md">
