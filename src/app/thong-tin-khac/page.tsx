    ...
    <>
      ...
      <section className="py-32 px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 h-auto md:h-[600px]">
          <div className="md:col-span-2 md:row-span-2 bg-[#00687b] rounded-3xl p-10 flex flex-col justify-between text-on-primary group cursor-pointer relative overflow-hidden">
          ...
          <div className="md:col-span-2 bg-surface-container-high rounded-3xl p-8 flex items-center gap-8 border border-outline-variant/10">
            ...
            <span className="material-symbols-outlined text-[#00687b] text-5xl opacity-30">family_restroom</span>
          </div>
